...
public class MFCalendarView extends LinearLayout {
    ...
    void init(Context context) {
        ...
        SimpleDateFormat df = new SimpleDateFormat("dd-MM-yyyy", Util.getLocale());
...
//                ((CalendarAdapter) parent.getAdapter()).setSelected(v);
                ...
                String gridvalueString = separatedTime[2].replaceFirst("^0*",
                        "");// taking last part of date. ie; 2 from 2017-12-02.
...
//                ((CalendarAdapter) parent.getAdapter()).setSelected(v);
            ...
            //    calendaradapter.initCalendarAdapter(month, calendarListener); //null pointer exception date to long utils
